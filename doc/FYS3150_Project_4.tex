...
\begin{document}
\title{On the Monte Carlo simulation of the Ising model of a 2D lattice with two-state spins using the Metropolis algorithm}   % self-explanatory
