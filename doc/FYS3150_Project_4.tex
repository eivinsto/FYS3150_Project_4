...
\section{Benchmark and timings} \label{sec:V:A}
...
\section{Simulation with a $2\times 2$ lattice} \label{sec:V:B}

\section{Simulations with a $20 \times 20$ lattice} \label{sec:V:C}

\section{Simulations with larger lattice sizes} \label{sec:V:D}
